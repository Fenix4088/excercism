...
public class TelemetryClient
{
    ...
    {
        if (this.car.GetTelemetryData(ref serialNum, out int batteryPercentage, out int distanceDrivenInMeters) == false || distanceDrivenInMeters == 0)
        {
            return "no data";
        }
